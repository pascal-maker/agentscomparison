...
class HFDataSearch:
    """
    Search tool for retrieving HuggingFace datasets.
    Filters datasets based on likes and downloads, and ranks them
    using TF-IDF cosine similarity on their descriptions.
    """
...
class SemanticScholarSearch:
    """
    Search tool utilizing the Semantic Scholar API to find relevant academic papers.
    Retrieves metadata such as titles, abstracts, citation counts, and publication dates.
    """
    def __init__(self):
...
class ArxivSearch:
    """
    Search tool utilizing the arXiv API.
    Provides methods to query papers by relevance, fetch their metadata,
    and download/extract the full PDF text.
    """
    def __init__(self):
