...
class Paper(db.Model):
    """
    SQLAlchemy model representing a PDF paper.
    Stores the filename and extracted text for semantic search.
    """
...
def update_papers_from_uploads():
    """
    Scans the uploads directory for new PDF files, extracts their text,
    and adds them to the database if they are not already present.
    """
